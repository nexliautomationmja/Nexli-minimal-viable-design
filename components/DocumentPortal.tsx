...
const DocumentPortal: React.FC = () => {
    ...
    const expandedStepCards = [
        ...
        { step: '03', title: 'Encrypted & Stored', description: "Files encrypted with AES-256 (bank-level) at rest and TLS in transit. Stored in your firm's isolated vault — never commingled with other firms.", bg: 'from-emerald-950 via-green-900 to-teal-900' },
    ...
    const securityFeatures = [
        { icon: <Lock size={16} className="text-cyan-400 md:w-[22px] md:h-[22px]" />, title: 'AES-256 Bank-Level Encryption', description: 'Every document encrypted with AES-256 — the same standard trusted by banks and the U.S. government to protect sensitive data.', iconDark: 'bg-cyan-500/10 border-cyan-500/20', iconLight: 'bg-cyan-50 border-cyan-200' },
