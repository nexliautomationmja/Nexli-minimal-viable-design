  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 md:gap-5 py-4 md:py-8">
      ...
      >
        ...
        >
          <TimerReset className="w-9 h-9 md:w-14 md:h-14 text-[#3b82f6]" strokeWidth={2} />
        </div>
      </motion.div>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative inline-flex items-center mb-3 md:mb-4 rounded-full overflow-hidden p-[1px]">
                ...
                <span className="relative z-10 inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[var(--bg-main)]">
                  ...
                  <span className="text-[10px] font-black tracking-[0.15em] uppercase text-cyan-300">The Growth Engine</span>
                </span>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="relative inline-flex items-center mb-3 md:mb-4 rounded-full overflow-hidden p-[1px]">
                ...
                <span className="relative z-10 inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[var(--bg-main)]">
                  ...
                  <span className="text-[10px] font-black tracking-[0.15em] uppercase text-purple-300">Built for Urgency</span>
                </span>
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              >
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl flex items-center justify-center bg-[#1a1400] border-2 border-[#fbbf24]/30"
                  style={{ filter: 'drop-shadow(0 0 24px rgba(251, 191, 36, 0.5))' }}
                >
                  <CalendarCheck className="w-9 h-9 md:w-11 md:h-11 text-[#fbbf24]" strokeWidth={2} />
                </div>
              </motion.div>
              ...
              <div className="relative inline-flex items-center mb-3 md:mb-4 rounded-full overflow-hidden p-[1px]">
                ...
                <span className="relative z-10 inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[var(--bg-main)]">
                  ...
                  <span className="text-[10px] font-black tracking-[0.15em] uppercase text-yellow-300">No Tire-Kickers</span>
                </span>
              </div>
            ...
            <div className="px-4 pb-4 md:px-6 md:pb-6 flex items-center justify-center">
              ...
              >
                ...
                <span className="relative z-10 inline-flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-[var(--bg-main)]">
                  ...
                  <span className="text-[var(--text-main)] text-[10px] md:text-sm font-black tracking-[0.1em] md:tracking-[0.15em] uppercase">Engagement Value</span>
                </span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="px-4 pb-4 md:px-6 md:pb-6 flex items-center justify-center">
              ...
              >
                ...
                />
                <span className="relative z-10 inline-flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-[var(--bg-main)]">
                  <TimerReset className="w-3.5 h-3.5 md:w-[18px] md:h-[18px] flex-shrink-0 text-[#3b82f6]" strokeWidth={2.5} />
                  <span className="text-[var(--text-main)] text-[10px] md:text-sm font-black tracking-[0.1em] md:tracking-[0.15em] uppercase">They Sign Fast</span>
                </span>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="px-4 pb-4 md:px-6 md:pb-6 flex items-center justify-center">
              ...
              >
                ...
                />
                <span className="relative z-10 inline-flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full bg-[var(--bg-main)]">
                  <DollarSign className="w-3.5 h-3.5 md:w-[18px] md:h-[18px] flex-shrink-0 text-[#fbbf24]" strokeWidth={2.5} />
                  <span className="text-[var(--text-main)] text-[10px] md:text-sm font-black tracking-[0.1em] md:tracking-[0.15em] uppercase">Premium Fees</span>
                </span>
              </motion.div>
            </div>
          </motion.div>
...
const VslFunnelOffer: React.FC<VslFunnelOfferProps> = ({ headline, subheadline, variant = 'A', muxPlaybackId, videoTitle, eyebrowText, eyebrowIcon, eyebrowTone, showHiddenDrain, showExitIntent = true }) => {
  useEffect(() => {
