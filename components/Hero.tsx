  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center pt-20 md:pt-24 pb-0 overflow-hidden bg-[var(--bg-main)]">
      ...
      <div className="max-w-4xl mx-auto px-6 w-full flex flex-col items-center text-center relative z-40">
        ...
        >
          You&rsquo;re running your firm across 6 disconnected tools.<br className="hidden sm:block" />
          The <span className="text-blue-500">Digital Rainmaker System</span> replaces them with one.
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-white/90 text-base md:text-2xl font-bold max-w-2xl mb-10 md:mb-12 drop-shadow-lg px-4"
        >
