        ...
        return (
            <div className="flex flex-col items-center justify-center gap-4 py-8">
                ...
                <motion.p
                    ...
                    className={`text-sm font-semibold ${theme === 'dark' ? 'text-white/70' : 'text-slate-600'}`}
                >
                    ...
                    <div className={`rounded-2xl border overflow-hidden ${theme === 'dark' ? 'bg-gradient-to-br from-slate-900 to-slate-950 border-white/10' : 'bg-gradient-to-br from-slate-100 to-white border-slate-200'}`}>
                        ...
                        <div className={`px-6 pb-6 flex items-center justify-center`}>
                            <motion.div
                                ...
                                className="relative inline-flex items-center rounded-full overflow-hidden p-[1.5px]"
                            >
                                ...
                                />
                                {/* Inner pill content */}
                                <span className="relative z-10 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[var(--bg-main)]">
                                    ...
                                    <span className="text-[var(--text-main)] text-xs md:text-sm font-black tracking-[0.15em] uppercase">Google Reviews</span>
                                </span>
                            </motion.div>
                        </div>
                    </div>
